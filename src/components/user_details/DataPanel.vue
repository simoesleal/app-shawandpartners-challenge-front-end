<template>
      ...
      >
        <div>
          <v-row no-gutters class="pa-2">
            <v-col cols="12">
              <p class="text-center">
                It seems to me that this user does not have any repository!
              </p>
            </v-col>
          </v-row>
        </div>
  ...
  <div v-else>
    <v-container v-if="user">
      <v-row>
        <v-col>
          <div class="mt-n12" :style="`height: ${320}px; min-width: ${100}%;`">
            <BaseSheet
              class="full-border-radius"
              :color="'white'"
              :dark="false"
        ...
        <v-col>
          <v-card rounded>
            <v-card-title>
              <v-col>
                <v-subheader>
                  <span class="text-h4 mr-3">{{ this.getNumberOfRepos }}</span>
